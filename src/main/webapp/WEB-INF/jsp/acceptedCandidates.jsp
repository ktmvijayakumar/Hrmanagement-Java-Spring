...
<div class="container content">
	...
	<div class="main-viewcandidate">
		<div class="content-viewcandidate">
			<center>
            <h2><span class="hr">Accepted</span> Candidates</h2>
            <p style="color:green; font-size:16px;">${successMessage}</p>
            <div class="round-one-result">
            <table class="table-hover acceptedCandidateTable">
                    <tr>
					...
					<tr>
						...
						<td class="tablecontent-viewcandidate"><a href="${pageContext.request.contextPath}/res/candidateDetailAcceptance?candidate_id=${candidate.candidate_id}">View</a></td>
					</tr>
					</c:forEach>
            </table>
            </div>
