...
<div class="container content">
	...
	<div class="main-viewcandidate">
		<div class="content-viewcandidate">
			<center>
            <h2><span class="hr">Employee</span> Table </h2>
            <p style="color:green; font-size:16px;">${successMessage}</p>
            <div class="round-one-result">
            <table class="table-hover employeetable">
                    <tr>
                        <th class="tabletitle-viewcandidate">SNo</th>
                        <th class="tabletitle-viewcandidate">employee Name</th>
                        <th class="tabletitle-viewcandidate">View Details</th>
                    </tr>
                    <c:forEach var="employee" items="${CandidateDetail}">
					<tr>
						<td class="tablecontent-viewcandidate"></td>
						<td class="tablecontent-viewcandidate"><c:out value="${employee.employee_name}" /></td>
						<td class="tablecontent-viewcandidate"><a href="${pageContext.request.contextPath}/res/employeeDetail?candidate_id=${employee.employee_id}">View</a></td>
					</tr>
					</c:forEach>
            </table>
            </div>
