		...
		<div class="content-viewcandidate">
            ...
            <table class="table-hover candidateLetterReleaseTable">
					...
					<tr>
						...
						<td class="tablecontent-viewcandidate"><a href="${pageContext.request.contextPath}/res/callLetterAcceptedDetail?candidate_id=${candidate.candidate_id}">Entry</a></td>
					</tr>
					</c:forEach>
            </table>
            </div>
