...
<div class="container content">
	...
	<div class="main">
		...
		<div class="content-profile">
			<h2 style="text-align:center"><span class="hr">Reallocate</span> Interview Info</h2>
	    	...
	    	<center>
	    	<div>
	    	<form method="POST" action="${pageContext.request.contextPath}/interview/reAllocateInterview">
	    		<input type="hidden" name="candidate_id" value="${candidateDetail.candidate_id}">
	   	        ...
	   	        <input type="date" name="interview_date" id="input-date"><br>
	   			<textarea rows="3" cols="28" name="interview_description" placeholder="Description"></textarea><br>
