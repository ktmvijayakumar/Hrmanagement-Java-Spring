...
<div class="container content">
	...
	<div class="main">
		...
		<div class="content-profile">
			<h2 style="text-align:center"><span class="hr">Call Letter</span> Acceptance Info</h2>
	    	...
	    	<center>
	    	<div>
	    	<form method="POST" action="${pageContext.request.contextPath}/res/callLetterAcceptanceInfoStatus">
	    		<input type="hidden" name="candidate_id" value="${candidateDetail.candidate_id}">
	   	       	<select style="width: 420px; font-size: 25px;padding:10px;" id="status_id" name="accept_status">
	   	       		  <option value="Accepted" id="status_id">Accept</option>
					  <option value="Not Accepted" id="status_id">Not accept</option>
				</select><br>
	   	        <input type="date" name="call_letter_accepteddate" required/><br>
	   	        <textarea rows="3" cols="28" name="call_letter_description" placeholder="Description"></textarea><br>
